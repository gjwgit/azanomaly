...
#                     #labels=unit_format(unit="M", scale=1e-6, sep="")) +
  labs(x="Daily Observations", y="Downloads",
       title="Actual Values versus Range of Expected Values",
       caption="GGPlot2 generated by Graham Williams")
ggsave("rattle-anom.pdf", width=10)
#system("evince rattle-anom.pdf")
ggsave("rattle-anom.png", width=12)
system("mogrify -resize 640 rattle-anom.png")
#system("display rattle-anom.png")

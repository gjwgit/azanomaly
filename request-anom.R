...
ggsave("request-anom.pdf", width=10)
#system("evince request-anom.pdf")
ggsave("request-anom.png", width=12)
system("mogrify -resize 640 request-anom.png")
#system("display request-anom.png")
